          ...
          <Paper variant="outlined" sx={{ p: 2.5, borderRadius: 2 }}>
            ...
            <ApexChart
              ...
              options={{
                ...
                xaxis: { categories: rows.map(r => String(r.clientName ?? "")), labels: { style: { fontSize: "11px" } } },
                colors: ["#00B4A6"],
      ...
      <DataGrid
        columns={[
          ...
          { field: "totalPaid", header: "Collected", align: "right", renderCell: v => formatCurrency(Number(v ?? 0)) },
          {
            ...
            align: "right",
            renderCell: v => (
              <Typography variant="body2" sx={{ color: Number(v) < 50 ? "error.main" : Number(v) < 80 ? "warning.main" : "success.main", fontWeight: 600 }}>
        ...
        queryFn={(p: GridParams) => reportsApi.getCollections(p)}
        FilterPanel={FilterPanel}
        hasFilters
        syncWithUrl
        defaultSortBy="collectionRate"
        defaultSortDir="desc"
      />
    </PageShell>
  )
