...
export default function WipReportPage(){
  ...
  return(
    <PageShell title={t("nav.reports-wip", "WIP Report")} description="Work in Progress — billable time not yet invoiced" action={<Button variant="outlined" size="small" startIcon={<DownloadIcon/>} onClick={()=>alert("Export not available in static mode")}>Export Excel</Button>}>
