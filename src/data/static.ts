...
export const clientDetail = { id:"c1",firstName:"Mohammed",lastName:"Al Rashid",companyName:"Al Rashid Holdings",clientType:"COMPANY",status:"OPEN",active:true,trnNo:"100123456",nationality:"UAE",email:"m@holdings.ae",phone:"+971501234567",openMatter:2,closedMatter:1,totalInvoiceAmount:25250,createdAt:"2024-06-01T09:00:00",address:"Dubai, UAE" }
...
export const matterDetail = { id:"6a4f9f5e096c2631a41a8193",matterId:"6a4f9f51096c2631a41a8113",title:"260303",matterSeq:"260303",matterSubject:"Building dispute — boundary and construction",practiceArea:{id:"pa4",name:"Litigation"},billingType:"Hourly",status:"OPEN",responsibleAttorney:{id:"u1",firstName:"Sarah",lastName:"Johnson"},client:{id:"c1",clientId:"c1",clientType:"COMPANY",companyName:"Al Rashid Holdings",firstName:""},openDate:"2026-07-09",dueDate:"2026-10-09",description:"Client requires representation in building boundary dispute.",partyOpposing:[{name:"Gulf Properties LLC",type:"Company"}],totalTimelogs:2,totalInvoices:1,pendingTasks:1,createdAt:"2026-07-09T17:17:05" }
export const matterTimelogs = [ {id:"tl1",activity:"Document Review",totalHours:3.5,billing:3500,revenueStatus:"DRAFT",entryDate:"2026-08-07",responsiblePerson:{firstName:"Sarah",lastName:"Johnson"}},{id:"tl3",activity:"Court Attendance",totalHours:6.0,billing:7200,revenueStatus:"APPROVED",entryDate:"2026-08-05",responsiblePerson:{firstName:"Mashood",lastName:"Rafi"}} ]
export const matterHearings = [ {id:"h1",hearingTitle:"First Directions Hearing",hearingDate:"2026-09-15",hearingTime:"10:00 AM",court:"Dubai Civil Court",room:"4B",status:"Scheduled",notes:"Both parties to attend with full disclosure."},{id:"h2",hearingTitle:"Settlement Conference",hearingDate:"2026-10-01",hearingTime:"02:00 PM",court:"Dubai Civil Court",room:"2A",status:"Scheduled",notes:"Mediation session."} ]
export const matterTasks = [ {id:"t1",taskName:"File initial pleadings",priority:"High",taskStatus:"Pending",taskDeadLine:"2026-08-20",assignedTo:{firstName:"Sarah",lastName:"Johnson"}},{id:"t2",taskName:"Gather evidence bundle",priority:"Normal",taskStatus:"Completed",taskDeadLine:"2026-08-10",assignedTo:{firstName:"Mashood",lastName:"Rafi"}} ]
export const matterInvoices = [ {id:"inv1",invoiceNo:"INV-2025-001",amount:15000,vatAmount:750,taxableAmount:15750,paidAmount:15750,balanceAmount:0,invoiceStatus:"Paid",issueDate:"2026-03-01",dueDate:"2026-03-31"} ]
