...
const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      { path: '/dashboard',         loader: protectedLoader(PERMISSIONS.DASHBOARD_VIEW),  element: L(() => import('./app/(dashboard)/dashboard/page')) },
      { path: '/leads',             loader: protectedLoader(PERMISSIONS.LEADS_VIEW),       element: L(() => import('./app/(dashboard)/leads/page')) },
      { path: '/leads/:leadId',     loader: protectedLoader(PERMISSIONS.LEADS_VIEW),       element: L(() => import('./app/(dashboard)/leads/[leadId]/page')) },
      ...
      { path: '/calendar',          loader: protectedLoader(PERMISSIONS.CALENDAR_VIEW),    element: L(() => import('./app/(dashboard)/calendar/page')) },
      { path: '/tasks',             loader: protectedLoader(PERMISSIONS.TASKS_VIEW),       element: L(() => import('./app/(dashboard)/tasks/page')) },
      { path: '/tasks/:taskId',     loader: protectedLoader(PERMISSIONS.TASKS_VIEW),       element: L(() => import('./app/(dashboard)/tasks/[taskId]/page')) },
      { path: '/billings',              loader: protectedLoader(PERMISSIONS.BILLING_VIEW), element: L(() => import('./app/(dashboard)/billings/page')) },
      { path: '/billings/:invoiceId',    loader: protectedLoader(PERMISSIONS.BILLING_VIEW), element: L(() => import('./app/(dashboard)/billings/[invoiceId]/page')) },
      { path: '/approvals/invoice', loader: protectedLoader(PERMISSIONS.BILLING_APPROVE),  element: L(() => import('./app/(dashboard)/approvals/invoice/page')) },
      { path: '/approvals/lfa',     loader: protectedLoader(PERMISSIONS.LFA_APPROVE),      element: L(() => import('./app/(dashboard)/approvals/lfa/page')) },
      { path: '/approvals/task',    loader: protectedLoader(PERMISSIONS.TASKS_VIEW),       element: L(() => import('./app/(dashboard)/approvals/task/page')) },
      { path: '/lfa',               loader: protectedLoader(PERMISSIONS.LFA_VIEW),         element: L(() => import('./app/(dashboard)/lfa/page')) },
      { path: '/lfa/:lfaId',         loader: protectedLoader(PERMISSIONS.LFA_VIEW),         element: L(() => import('./app/(dashboard)/lfa/[lfaId]/page')) },
      { path: '/lfa/default',       loader: protectedLoader(PERMISSIONS.LFA_VIEW),         element: L(() => import('./app/(dashboard)/lfa/default/page')) },
      { path: '/lfa/reports',       loader: protectedLoader(PERMISSIONS.LFA_VIEW),         element: L(() => import('./app/(dashboard)/lfa/reports/page')) },
      { path: '/lfa/client',        loader: protectedLoader(PERMISSIONS.LFA_VIEW),         element: L(() => import('./app/(dashboard)/lfa/client/page')) },
      { path: '/reports/wip',           loader: protectedLoader(PERMISSIONS.REPORTS_VIEW), element: L(() => import('./app/(dashboard)/reports/wip/page')) },
      { path: '/reports/billed-amount', loader: protectedLoader(PERMISSIONS.REPORTS_VIEW), element: L(() => import('./app/(dashboard)/reports/billed-amount/page')) },
      { path: '/reports/matter-billing',loader: protectedLoader(PERMISSIONS.REPORTS_VIEW), element: L(() => import('./app/(dashboard)/reports/matter-billing/page')) },
      { path: '/reports/utilization',   loader: protectedLoader(PERMISSIONS.REPORTS_VIEW), element: L(() => import('./app/(dashboard)/reports/utilization/page')) },
      { path: '/reports/activity-history', loader: protectedLoader(PERMISSIONS.REPORTS_VIEW), element: L(() => import('./app/(dashboard)/reports/activity-history/page')) },
      { path: '/reports/margin-erosion',   loader: protectedLoader(PERMISSIONS.REPORTS_VIEW), element: L(() => import('./app/(dashboard)/reports/margin-erosion/page')) },
      { path: '/reports/collections',      loader: protectedLoader(PERMISSIONS.REPORTS_VIEW), element: L(() => import('./app/(dashboard)/reports/collections/page')) },
